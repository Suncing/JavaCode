...
public class B_FolderOprate {
    private static String path ="D:\\Zoom\\github\\JavaCode\\improve\\src\\main\\java\\Java初级\\文件\\生成文件夹\\生成文件夹的文件夹";
    private static String path2 ="D:\\Zoom\\github\\JavaCode\\improve\\src\\main\\java\\Java初级";
